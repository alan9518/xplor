...
// --------------------------------------
    class Routes {
        ...
        async getNavigationRoutesfromAPI() {
            ...
            const redirectRoute = {redirect:true, path:'/', to : `${path}/catalogue`, navbarName: 'Redirect', key : 'index-route' }

            navigationArray.push(homeRoute);
            navigationArray.push(redirectRoute);
